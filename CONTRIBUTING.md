...
3. Fill in an example:
   | name | cuisine | price | rating | area | url | hours | notes |
   |---|---|---|---|---|---|---|---|
   | Example Restaurant | Local Johor Cuisine | ¥50-100 | 4.5 | Johor | https://example.com | Mon-Sun 11:00-21:00 | Example note 😋 |

5. Open a new branch and create a PR.
6. After the PR is merged into the default branch (main/master), GitHub Actions will automatically run `readme_render.py` and commit the generated `README.md`.
